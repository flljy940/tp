...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "The index provided is invalid!\n"
            + "The index should be a positive integer up to the number of the last student shown.";
    public static final String MESSAGE_EMPTY_LIST_PAYMENT_STATUS = "No students found. Payment statuses were not reset.";
