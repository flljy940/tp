...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
            ...
            @JsonProperty("nextLesson") String nextLesson, @JsonProperty("tags") List<JsonAdaptedTag> tags) {
        this.name = name;
        this.phone = phone;
        this.email = email;
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        return new Person(modelName, modelPhone, modelEmail, modelAddress, modelNextLesson, modelTags);
    }
