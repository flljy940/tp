...
public class CommandTestUtil {
    ...
    public static final String SUBJECT_DESC_CHEMISTRY = " " + PREFIX_SUBJECT + VALID_SUBJECT_CHEMISTRY;
    ...
    public static final String INVALID_SUBJECT_DESC = " " + PREFIX_SUBJECT + "math*"; // '*' not allowed in tags
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withSubjects(VALID_SUBJECT_CHEMISTRY).build();
